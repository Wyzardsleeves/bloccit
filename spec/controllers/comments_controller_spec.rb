...
RSpec.describe CommentsController, type: :controller do
  ...
  #creates specs for guest users, who will redirect to sign in if they attempt to create or delete  comment
  context "guest" do
  ...
  #creates specs for members users who attmpt to create new comments or delete comment they don't own
  ...
  end #context "member user doing CRUD on a comment they don't own"

  #test that members users are able to create new comments and delete their own comments
  context "member user doing CRUD on the comment they own" do
    before do
  ...
  end #context "member user doing CRUD on the comment they own"

  context "admin user doing CRUD on the comment they don't own" do
    before do
      other_user.admin!
      create_session(other_user)
    end
  ...
  end #ccontext "admin user doing CRUD on the comment they don't own"

end #RSpec.describe CommentsController
