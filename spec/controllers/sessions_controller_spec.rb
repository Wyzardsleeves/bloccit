...
RSpec.describe SessionsController, type: :controller do
  ...
  describe "POST sessions" do
    ...
    it "it initializes a session" do
    ...
    it "renders #new with bad emai address" do
      post :create, session: {email: "does not exist"}
  ...
  end #describe "DELETE sessions/id"


end #RSpec.describe SessionsController
